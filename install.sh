...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210140944-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Oct 14, 2022 09:44 EDT
# @@File             :  install.sh
# @@Description      :
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/podman"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="podman"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/podman"
APPDIR="$HOME/.local/share/srv/docker/podman"
DATADIR="$HOME/.local/share/srv/docker/podman/files"
...
CUSTOM_ARGUMENTS="--shm-size=$CONTAINER_SHM_SIZE --tty "
CUSTOM_ARGUMENTS+=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
if docker ps -a | grep -qs "$APPNAME"; then
  ...
  [ -z "$CONTAINER_SERVICE_PORT" ] && printf_yellow "This container does not have service" || printf_cyan "Service is running on $SERVER_SERVICE_ADDR or $SERVER_HOST_NAME:$CONTAINER_SERVICE_PORT"
